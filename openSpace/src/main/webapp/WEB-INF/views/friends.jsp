				...
				<div class="panel panel-primary">
					...
					<div class="panel-body text-center">
						<ul class="caption-style-1">
							...
							<li><img src="http://pikchyriki.net/avatar/krutye/140/3.jpg"
								alt="">
								<div class="caption">
									<div class="blur"></div>
									<div class="caption-text">
							...
							<li><img
								src="http://pikchyriki.net/avatar/devushki/140/50.gif" alt="">
								<div class="caption">
									<div class="blur"></div>
									<div class="caption-text">
										<h1>Hellen</h1>
							...
							<li><img src="http://pikchyriki.net/avatar/emo/140/35.jpg"
								alt="">
								<div class="caption">
									<div class="blur"></div>
									<div class="caption-text">
							...
							<li><img src="http://pikchyriki.net/avatar/deti/140/60.jpg"
								alt="">
								<div class="caption">
									<div class="blur"></div>
									<div class="caption-text">
							...
							<li><img
								src="http://pikchyriki.net/avatar/znamenitosti/140/3.jpg" alt="">
								<div class="caption">
									<div class="blur"></div>
									<div class="caption-text">
										<h1>Kira</h1>
